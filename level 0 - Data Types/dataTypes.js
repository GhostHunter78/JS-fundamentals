...
let slicedWord = challenge.substring(0, challenge.indexOf(" "));
...
challenge.includes("Script") ? console.log("true") : console.log("false");
...
challenge.startsWith("30") ? console.log(true) : console.log(false);

// 22 - Use endsWith() method with the string 30 Days Of JavaScript and make the result true
challenge.endsWith("t") ? console.log(true) : console.log(false);
